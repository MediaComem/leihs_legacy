module TimelineAvailability
  ...
  included do
    ...
    def entitlement_groups(entitlement_groups_users)
      group_ids = entitlement_groups_users.map { |r| r['entitlement_group_id'] }
    ...
    def entitlements(inventory_pool_id, model_id)
      ...
      query = <<-SQL
        ...
        from
        	entitlements
        where
        	entitlements.inventory_pool_id = '#{inventory_pool_id}'
          and model_id = '#{model_id}'
      SQL
    ...
    def timeline_availability(model_id, inventory_pool_id)
      ...
      entitlement_groups = entitlement_groups(entitlement_groups_users)
