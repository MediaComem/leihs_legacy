Rails.application.routes.draw do
  ...
  namespace :borrow do
    ...
    post    "reservations/create_legacy",     to: "reservations#create_legacy"
    post    "reservations/change_time_range", to: "reservations#change_time_range", as: "change_time_range"
    delete  "reservations/:line_id",          to: "reservations#destroy_legacy"
  ...
  namespace :manage do
    ...
    scope ":inventory_pool_id/" do
      ...
      get     'models/:id/new_timeline',          to: "models#new_timeline"
